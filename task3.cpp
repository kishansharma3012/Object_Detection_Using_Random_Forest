...
float prob_threshold[] = {0.65,0.75,0.8};
...
int main(int argc, char** argv){
    ...
    std::vector< std::vector<float> > final_locations;
    std::string image_path = std::string("/home/student18/Desktop/TDCV2/data/task3/test/") + std::string(argv[1]) +std::string(".jpg");
    std::string file_path = std::string("/home/student18/Desktop/TDCV2/data/task3/gt/") + std::string(argv[1]) +std::string(".gt.txt");
...
void get_data_and_labels(vector<Mat1f>& label_per_feats, Mat& labels)
{
    String imagePath("/home/student18/Desktop/TDCV2/data/task3/");
